...
Nakon dva modela za Node Classification, napravili smo dva modela i za Graph Classification. Za početak smo učitali MUTAG dataset. Konkretno, MUTAG je zbirka nitroaromatskih spojeva i cilj je predvidjeti njihovu mutagenost na Salmonellu typhimurium. Ulazni grafovi koriste se za predstavljanje kemijskih spojeva, gdje čvorovi predstavljaju atome i označeni su vrstom atoma, dok bridovi između čvorova predstavljaju veze između odgovarajućih atoma. Uključuje 188 uzoraka kemijskih spojeva sa 7 diskretnih oznaka čvorova.
